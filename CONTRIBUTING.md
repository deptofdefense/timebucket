# Contributing to timebucket

Thank you for your interest in contributing.  Below is some brief guidance for contributing to this project.

## Authors

See [AUTHORS](https://github.com/deptofdefense/timebucket/blob/master/AUTHORS) for a list of contributors.  When making a contribution, please add yourself to the list if you like.
...
Please submit bugs or issues to <https://github.com/deptofdefense/timebucket/issues>.
